...
def get_unique_name(root_project_path):
    ...
    return result
changed_files = get_local_changed_files(ROOT_PROJECT_PATH)
...
to_renew_metadata = []
for project in projects:
    build_date = artifact_build_date(project, MAVEN_REPO_PATH)
...
renew_metadata(to_renew_metadata, MAVEN_REPO_PATH)
